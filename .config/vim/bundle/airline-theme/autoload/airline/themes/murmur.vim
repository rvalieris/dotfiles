" from: https://github.com/vim-airline/vim-airline-themes/blob/master/autoload/airline/themes/murmur.vim
...
let s:N2 = [s:gui_normalbg, s:gui_termbg2, s:cterm_normalbg, s:cterm_termbg2]     " Middle block
